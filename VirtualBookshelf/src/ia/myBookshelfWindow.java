...
public class myBookshelfWindow extends JFrame {
	private JLabel headerText;
	private JFrame frame;
	
	public myBookshelfWindow(String newName) {
		
		// JFrame
		JFrame frame = new JFrame("My Bookshelf"); 
        ...
        JLabel headerText = new JLabel("My Bookshelf");
        ...
        readerProfileButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
         	   ...
         	   new readerProfileWindow(newName);
            }
        });
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new myBookshelfWindow("").setVisible(true);
            }
        });
	}
